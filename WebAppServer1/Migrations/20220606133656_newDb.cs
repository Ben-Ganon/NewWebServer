        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UserFUsername = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chats_Users_UserFUsername",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_Users_UserFUsername",
                        column: x => x.UserFUsername,
                        principalTable: "Users",
                        principalColumn: "Username");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chats_UserFUsername",
                table: "Chats",
                column: "UserFUsername");

            migrationBuilder.CreateIndex(
                name: "IX_Contacts_UserFUsername",
                table: "Contacts",
                column: "UserFUsername");
